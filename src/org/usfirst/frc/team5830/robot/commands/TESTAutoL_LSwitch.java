 ...
 */
public class TESTAutoL_LSwitch extends CommandGroup {

    public TESTAutoL_LSwitch() {
    	/*
    	...
    	addSequential(new MotionProfiling(0, Robot.distanceWallToSwitch)); //MotionProfiling values = (<angle>, <distance>)
