 ...
 *
 */
public class TESTMAINAutoCSwitch extends CommandGroup {
	
	Command commandLSwitch;
	Command commandRSwitch;

    public TESTMAINAutoCSwitch() {
    	
    	commandLSwitch = new TESTAutoC_LSwitch();
    	commandRSwitch = new TESTAutoC_RSwitch();
